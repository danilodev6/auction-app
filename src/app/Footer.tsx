...
export default function Footer() {
  return (
    <footer className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-40 bg-primary text-white px-4 sm:px-6 lg:px-9 h-auto min-h-[3.5rem] py-3 rounded-md shadow-lg w-[calc(100vw-2rem)] max-w-md animate-fade-in-up delay-100">
