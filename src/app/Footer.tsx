...
export default function Footer() {
  return (
    <footer className="fixed flex place-items-center bottom-4 left-1/2 animate-fade-in-up delay-100 transform -translate-x-1/2 bg-primary text-white px-3 sm:px-6 lg:px-9 h-auto min-h-[3.5rem] py-3 rounded-md shadow-lg z-40 w-[calc(100vw-1rem)] max-w-4xl">
