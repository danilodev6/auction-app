...
export default function Footer() {
  return (
    <footer className="fixed bottom-4 left-4 right-4 animate-fade-in-up delay-100 bg-primary text-white px-4 sm:px-6 lg:px-9 h-auto min-h-[3.5rem] py-3 rounded-md shadow-lg z-40 mx-auto max-w-6xl">
